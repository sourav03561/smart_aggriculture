...
/* 	.custom-row-visu{
	    ...
	    <div class="leftContainer">
				<div class="navbar">
					...
					<a href="dashboard.php" target="contentFrame" class="selected">Home</a>
	    ...
	    <div class="row custom-row-visu">
	        <div class="col-md-12 my-5 d-flex justify-content-center">
	            <h1 style="text-align: center;" class="custom-header">Data Visulization</h1>
	        </div>
	
	        <div class="col-md-12 select-custom-visu" style="text-align: center;">
	            <label for="mySelect" style="margin-right: 10px;" class="label-custom">Select an option:</label>
	            <select id="mySelect" style="margin-right: 20px;" class="dropdown-custom"></select>
	        
	            <label for="mySelect1" style="margin-right: 10px;" class="label-custom">Select a Chart Type:</label>
             ...
             $.ajax({
                ...
                success: function(response) {
                    ...
                    console.log(response);
                      ...
                      avgElement.innerText = numericValue;
